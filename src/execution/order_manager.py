...
class OrderManager:
    ...
    def place_limit_buy(
        ...
        try:
            ...
            return OrderResult(
                success=False, error=f"Insufficient funds: {str(e)}"
            )

        except ccxt.InvalidOrder as e:
            return OrderResult(success=False, error=f"Invalid order: {str(e)}")

        except ccxt.NetworkError as e:
            return OrderResult(success=False, error=f"Network error: {str(e)}")
